...
def receptive_field(model, input_size, batch_size=-1, device="cuda"):
        ...
        def hook(module, input, output):
            ...
            if not receptive_field["0"]["conv_stage"]:
                ...
                if class_name == "Conv2d" or class_name == "MaxPool2d" or class_name == "AvgPool2d" :
                    ...
                    _, _, h, w = receptive_field[str(int(module_idx - 1))]['output_shape']
                    kernel_size = (h,w)
                    stride = (h,w)
                    padding = (0,0)
                    dilation=1
            ...
            receptive_field[m_key]["layer_name"] = class_name
        if (
    ...
    receptive_field["0"]["layer_name"]="Input"
    hooks = []
    ...
    print("------------------------------------------------------------------------------")
    line_new = "{:>7} {:>15} {:>15} {:>10} {:>10} {:>15} ".format("Layer","Layer name", "map size", "start", "jump", "receptive_field")
    print(line_new)
    print("==============================================================================")
    total_params = 0
    total_output = 0
    ...
    for layer in receptive_field:
        ...
        line_new = "{:>7} {:>15} {:>15} {:>10} {:>10} {:>15}".format(#
            #"",
            layer,
            receptive_field[layer]["layer_name"],
