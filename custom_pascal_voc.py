...
class pascal_voc(imdb):
    ...
    def image_path_from_index(self, image_name):
        ...
        #image_path = os.path.join(cfg.FLAGS2["custom_image_dir"],image_name + self._image_ext)
    ...
    def _do_python_eval(self, output_dir='output'):
        ...
        for i, cls in enumerate(self._classes):
            ...
            #save_name = os.path.join(path, os.path.splitext(file)[0] + '.txt')
...
if __name__ == '__main__':
    ...
    path='H:\dataset\SeaShips\Annotations'
    class_names=annotation_classes_name(path)
    with open('H:\dataset\SeaShips\class.txt','w') as f:
